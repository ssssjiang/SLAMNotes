...
int main(int argc, char **argv) {
    ...
    for (int v = 0; v < left.rows; v++)
        for (int u = 0; u < left.cols; u++) {
            ...
            // 根据双目模型计算 point 的位置
            double depth = fy * b / disparity.at<uchar>(v, u);
            // Vector3d normalized_point = K.inverse() * Vector3d(u, v, 1);
            // point[0] = normalized_point[0] * depth;
            // point[1] = normalized_point[1] * depth;
